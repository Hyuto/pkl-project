...
Menghapus retweet dan baris yang mengandung `NA` di dalam data.
...
```{r}
set.seed(2021)
sample.data <- sample_n(data, 1500)
glimpse(sample.data)
```
...
### 1. Mengganti Emoji & Menghapus HTML tag
...
```{r}
write.csv(sample.data, "../data/clean-sample-data.csv", row.names = FALSE)
```
